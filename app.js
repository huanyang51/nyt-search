$("#search").click(function() {
  ...
  var callURL = `https://api.nytimes.com/svc/search/v2/articlesearch.json?q=${searchTerm}&begin_date=${startDate}&end_date=${endDate}&api-key=kdjdawKhMdyUhJm90JcVk30M0ryADXkg`;
  console.log(callURL);
  $("#search").click(function() {
    event.preventDefault();
    console.log("yosdfd");
